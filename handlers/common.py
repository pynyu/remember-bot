...
HELP_TEXT = (
    ...
    "<b>🔔 Щоб не пропустити (телефон беззвучний / спиш)</b>\n"
    "• <b>Завчасні попередження</b>: я нагадаю <b>напередодні ввечері</b> та "
    "<b>зранку</b> в день події — щоб не проспати ранкову зустріч. Вмикається "
    "автоматично; час «вечора/ранку» та кнопки 🌙☀️⏰ — під кожним нагадуванням і в ⚙️.\n"
    "• Нагадаю <b>кілька разів</b> поспіль, поки не натиснеш «✅ Готово».\n"
    "• додай <i>×3</i> у кінці — нагадаю 3 рази; <i>важливо</i> — зі звуком\n"
